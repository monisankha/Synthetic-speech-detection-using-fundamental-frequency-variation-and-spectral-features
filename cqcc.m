function  [CQcc_s,CQcc_sdD,CQcc_dD,CQcc_D,LogP_absCQT, TimeVec, FreqVec, Ures_LogP_absCQT, Ures_FreqVec] = ...
...
if strcmp(strrep(ZsdD,'Z',''), 'sdD')
    CQcc_s=CQcepstrum_temp;
    CQcc_sdD = [CQcepstrum_temp; Deltas(CQcepstrum_temp,f_d); ...
        Deltas(Deltas(CQcepstrum_temp,f_d),f_d)];
    CQcc_dD=   [Deltas(CQcepstrum_temp,f_d); Deltas(Deltas(CQcepstrum_temp,f_d),f_d)];
    CQcc_D=Deltas(Deltas(CQcepstrum_temp,f_d),f_d);
