...
clc;
clear;
timit=importdata('male_list.txt');
...
save timit_ubm_512_mfcc_nvad_rasta_60_male.mat ubm
%%--------------------------------------------------------------------------
clc;
clear;
TargetList=importdata('ASV_male_enrolment.ndx');
load timit_ubm_512_mfcc_nvad_rasta_60_male.mat;
for i=1:15
...
save ASVspoof_Joint_ASV_CM_Male_Dev_GMMUBM_512_SCORE_mfcc_nvad_rasta_60_R_3.mat Score;
%% eer computation (dev)
clc;
clear;
fid = fopen('ASV_male_development.ndx');
...
load ASVspoof_Joint_ASV_CM_Male_Dev_GMMUBM_512_SCORE_mfcc_nvad_rasta_60_R_3.mat
...
fileID = fopen('development_spoofing_male.txt','w');
...
fileID = fopen('development_spoofing_joint_cm_ASV_male.txt','w');
...
for i=1:size(ListOfTrialFiles,1)
    ...
    try
        ...
        count=count+1;
        NoDataList{count}=filepath;
        Score(i)= NaN;
    end    
    disp(i);
end
save ASVspoof_Joint_ASV_CM_Male_Eval_GMMUBM_512_SCORE_mfcc_nvad_rasta_60_R_3.mat Score;
%--------------------------------------------------------------------------
clc;
clear;
fid = fopen('ASV_male_evaluation.ndx');
...
load ASVspoof_Joint_ASV_CM_Male_Eval_GMMUBM_512_SCORE_mfcc_nvad_rasta_60_R_3.mat
...
fileID = fopen('evaluation_spoofing_male_known_attacks.txt','w');
fprintf(fileID,'%6s %6s %6s %6s %6s %6s \r\n','eer_baseline','eer_s1','eer_s2','eer_s3','eer_s4','eer_s5');
fprintf(fileID,'%6.4f %6.4f %6.4f %6.4f %6.4f %6.4f\r\n',(eer_baseline*100),(eer_s1*100),(eer_s2*100),(eer_s3*100),(eer_s4*100),(eer_s5*100));
fclose(fileID);

fileID = fopen('evaluation_spoofing_male_unknown_attacks.txt','w');
...
fileID = fopen('evaluation_spoofing_joint_cm_ASV_male_known_attacks.txt','w');
fprintf(fileID,'%6s %6s %6s %6s %6s \r\n','eer_s1_cm','eer_s2_cm','eer_s3_cm','eer_s4_cm','eer_s5_cm');
fprintf(fileID,'%6.4f %6.4f %6.4f %6.4f %6.4f\r\n',(eer_s1_cm*100),(eer_s2_cm*100),(eer_s3_cm*100),(eer_s4_cm*100),(eer_s5_cm*100));
fclose(fileID);

fileID = fopen('evaluation_spoofing_joint_cm_ASV_male_unknown_attacks.txt','w');
